 ...
 * 
 * Renders Call and WhatsApp buttons stacked vertically in the bottom-left corner.
 */
export default function FloatingContact() {
  return (
    <div className="fixed bottom-6 left-6 z-50 flex flex-col space-y-2.5">
      {/* 1. Direct Call Button */}
      <div className="flex items-center space-x-3 group">
        <a
          href="tel:+919346305355"
          className="w-10 h-10 rounded-full bg-gradient-to-tr from-gold-500 to-gold-600 text-white flex items-center justify-center shadow-lg border border-gold-400/20 hover:border-white transition-all duration-300 hover:scale-105 active:scale-95 hover:rotate-6 relative"
      ...
      <div className="flex items-center space-x-3 group">
        <a
          href="https://wa.me/919346305355?text=Hi!%20I'm%20interested%2520in%2520shopping%2520at%2520Sai%2520Trends."
          target="_blank"
          rel="noopener noreferrer"
          className="w-10 h-10 rounded-full bg-gradient-to-tr from-emerald-500 to-green-600 text-white flex items-center justify-center shadow-lg border border-gold-400/20 hover:border-white transition-all duration-300 hover:scale-105 active:scale-95 hover:rotate-6 relative"
